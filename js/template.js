	...
	$(document).ready(function(){
		...
		if($("#contact-form").length>0) {
			$("#contact-form").validate({
				...
				messages: {
					name: {
						required: "Por favor espeficica tu nombre",
						minlength: "Tu nombre debe ser mayor a 2 caracteres."
					},
					email: {
						required: "Necesitamos tu email para contactarte",
						email: "Por favor ingresar un email valido ej: name@domain.com"
					},
					subject: {
					...
					message: {
						...
						minlength: "Tu mensaje debe ser mayor a 10 caracteres."
					}					
				},
				errorElement: "span",
